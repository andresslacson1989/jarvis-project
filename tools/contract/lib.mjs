...
export const CANONICAL_VALUES_PATH = "packages/schemas/src/canonical/v1/jarvis-v1.0.8.contract-values.json";
export const MANIFEST_PATH = "docs/JARVIS-CONTRACT-MANIFEST-v1.0.8.md";
export const GENERATED_JSON_PATH = "generated/contract/jarvis-v1.0.8.contract-values.generated.json";
export const GENERATED_TS_PATH = "generated/contract/jarvis-v1.0.8.contract-values.generated.ts";
