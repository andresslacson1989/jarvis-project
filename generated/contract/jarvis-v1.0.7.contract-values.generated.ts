...
// Source: packages/schemas/src/canonical/v1/jarvis-v1.0.7.contract-values.json
// Source SHA-256: ad1c44d47e56598a6ad3d1d48720d2ee153a4b90fa5526fd4c104b4a57b9feb3
...
export const JARVIS_CANONICAL_CONTRACT_VALUES = {
  ...
  "contractComponentRevisions": {
    "scopeGovernanceCoding": "1.0.7",
    "runtimePlatformProtocol": "1.0.7",
    "dataStateBackup": "1.0.7",
    "securityTrust": "1.0.7",
    "operationsIntegrationsUx": "1.0.7",
    "verificationRelease": "1.0.7",
    "releaseProfile": "1.0.7"
  },
  "protocolMajor": 1,
  "v1RuntimeTarget": {
    "platform": "WINDOWS",
