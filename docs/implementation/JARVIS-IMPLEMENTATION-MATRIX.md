...
| Active subsection | `0.CP` — Phase 0 checkpoint verification |
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **IN PROGRESS** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | — | `0.CP` aggregate checkpoint proof is in progress | `0.1–0.13` verified; section checkpoint active |
...
| ↳ **0.CP** SECTION CHECKPOINT — Phase 0 clean-checkout, governance, platform-boundary, and drift proof | **IN PROGRESS** | 0.1–0.13 | PLAN §2 Exit; PLAN §26 checkpoint; VR §§6,9,33 | — | Aggregate Phase 0 checkpoint harness/evidence not yet complete | Contract packet established from Phase 0 Exit, PLAN §26, and VR §§6,9,33; child subsections `0.1–0.13` are verified |
