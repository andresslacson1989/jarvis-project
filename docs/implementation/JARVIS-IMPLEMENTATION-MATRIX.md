...
| Active subsection | None — `0.9` verified; `0.10` not started |
| Next eligible subsection | `0.10` |
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **IN PROGRESS** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | — | `0.10` is next | `0.1–0.9` verified; section checkpoint remains pending |
