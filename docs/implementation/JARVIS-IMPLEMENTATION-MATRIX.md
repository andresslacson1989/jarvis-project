...
| Active subsection | None — `0.11` verified; `0.12` not started |
| Next eligible subsection | `0.12` |
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **IN PROGRESS** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | — | `0.12` is next | `0.1–0.11` verified; section checkpoint remains pending |
