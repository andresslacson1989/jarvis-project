...
**Current candidate under audit:** `511f76fc9008a68b34486ce58b6c3a06db7337a8`
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **VERIFYING** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | 10 CA / 8 scoped | Qualified current-v1.0.7 authority evidence is outstanding; prior v1.0.6/GitHub evidence is historical and cannot close this section | Candidate `511f76fc...` repository checks pass; LocalCI remains unqualified because native-Windows worker and terminal control-plane evidence are unavailable; see `docs/implementation/evidence/0.CP-phase0-checkpoint.md` |
