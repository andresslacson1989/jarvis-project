...
| Active subsection | None — `0.7` verified; `0.8` not started |
| Next eligible subsection | `0.8` |
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **IN PROGRESS** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | — | `0.8` is next | `0.1–0.7` verified; section checkpoint remains pending |
