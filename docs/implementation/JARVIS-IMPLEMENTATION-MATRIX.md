...
| Active subsection | None — `0.8` verified; `0.9` not started |
| Next eligible subsection | `0.9` |
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **IN PROGRESS** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | — | `0.9` is next | `0.1–0.8` verified; section checkpoint remains pending |
