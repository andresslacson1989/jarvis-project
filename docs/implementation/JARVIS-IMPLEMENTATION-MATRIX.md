...
**Implementation candidate under audit:** `6c72d9f9861ff858e34754d4bddcb749c6950598`
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **VERIFYING** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | 10 CA / 8 scoped | Qualified current-v1.0.7 authority evidence is outstanding; prior v1.0.6/GitHub evidence is historical and cannot close this section | Candidate `6c72d9f...` repository checks pass; LocalCI remains unqualified because native-Windows worker and terminal control-plane evidence are unavailable; see `docs/implementation/evidence/0.CP-phase0-checkpoint.md` |
...
| ↳ **0.CP** SECTION CHECKPOINT — Phase 0 clean-checkout, governance, platform-boundary, and drift proof | **VERIFYING** | 0.1–0.13 | PLAN §2 Exit; PLAN §26 checkpoint; VR §§6,9,33 | 10 CA / 8 scoped | Qualified current-v1.0.7 authority evidence is outstanding; historical checkpoint evidence is explicitly superseded | Candidate `6c72d9f...` passes repository-side controls; no qualified LocalCI run exists; native-Windows worker, immutable metadata, terminal evidence finalization, fresh audit, and integration remain outstanding |
...
| ↳ **1.2** Tauri capabilities, CSP, navigation, external-link, devtools, and inert-content security | **VERIFYING** | 1.1 | PLAN §3; IC §6; RT §5; SEC §20; CS §25; VR §12 | — | Candidate-bound remediation is complete locally; qualified-authority exact-SHA CI, external LocalCI qualification evidence, fresh audit approval, and controlled integration/post-integration verification remain required | Current candidate `6c72d9f...`; prior candidates remain historical. LocalCI is `VERIFYING`, not qualified; Section 1.3 is not eligible. |
