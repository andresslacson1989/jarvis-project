...
| Active subsection | None — `0.6` verified; `0.7` not started |
| Next eligible subsection | `0.7` |
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **IN PROGRESS** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | — | `0.7` is next | `0.1–0.6` verified; section checkpoint remains pending |
