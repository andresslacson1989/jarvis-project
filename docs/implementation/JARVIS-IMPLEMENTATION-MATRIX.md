...
| Active subsection | None — `0.10` verified; `0.11` not started |
| Next eligible subsection | `0.11` |
...
|---|---|---|---|---:|---|---|
| **SECTION 0 — Repository / Platform Contracts / Toolchain / Governance** | **IN PROGRESS** | — | `Phase 0`; checkpoint: Repository Governance + Platform Boundary + Contract-Drift Protection Ready | — | `0.11` is next | `0.1–0.10` verified; section checkpoint remains pending |
