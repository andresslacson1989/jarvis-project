...
**Qualified CI authority equivalence:** ADR-076
...
The current production contract consists of this file plus the exact documents and component revisions listed in `docs/JARVIS-CONTRACT-MANIFEST-v1.0.7.md`.
