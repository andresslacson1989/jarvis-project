...
| Offline TUF release-role custody copies | `K:\TUF-TARGETS-CUSTODY\`, `K:\TUF-MODULES-CUSTODY\`, `K:\TUF-SNAPSHOT-CUSTODY\`, `K:\TUF-TIMESTAMP-CUSTODY\` and matching directories under `L:\` | Fresh separated private role keys generated by the offline hierarchy ceremony; targets/modules are 2-of-3, snapshot/timestamp are 1-of-1 | Present on both encrypted volumes; do not print or copy contents |
