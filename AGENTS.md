...
installed desktop host opened visibly but Core reported
`PERSISTENCE_SCHEMA_INVALID` against the existing user database at
`%LOCALAPPDATA%\JARVIS\data\state.db`. Do not delete or overwrite that database
